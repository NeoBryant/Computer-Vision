...
public:
	CImg<unsigned char> run(CImg<unsigned char> src, vector<pair<int,int> > corner);
...
CImg<unsigned char> MyImageWarping::run(CImg<unsigned char> src, vector<pair<int,int> > corner) {
	this->srcImg = src;
